    ...
    <section className="h-screen w-full flex flex-col justify-center items-center text-center px-6 bg-gray-950 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl space-y-8">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
          <button className="px-8 py-3 rounded-full bg-blue-600 hover:bg-blue-700 transition-all duration-300 font-semibold shadow-lg shadow-blue-600/20 flex items-center justify-center gap-2 transform hover:-translate-y-1">
            {/* Search Icon */}
          ...
          <button className="px-8 py-3 rounded-full border border-gray-700 hover:border-gray-500 hover:bg-gray-800 transition-all duration-300 font-medium">
